...
<?php 
$langue = langue();
//on recupere l'id de l'user et du journal
$id_journal_mod = $datas;
$id_journal = substr($id_journal_mod,3);
$id_user = id_user_de_journal($id_journal);
// on paye le membre et ses parrains
payer_membre_et_parrain($id_user);
// on redirige immédiatement
echo "<script type='text/javascript'>document.location.replace('index.php?page=page-mdps2&id=$id_journal_mod');</script>";
?>